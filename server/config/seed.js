...
var _employee = require('../api/employee/employee.model');

var _employee2 = _interopRequireDefault(_employee);

var _client = require('../api/report/client.model');

var _client2 = _interopRequireDefault(_client);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_client2.default.find({}).remove().then(function () {
  _client2.default.create({
    year: 2015,
    january: [{
      "first_name": "Adam",
      "last_name": "Griffin",
      ...
      "first_name": "Patricia",
      "last_name": "Bradley",
      "client": ["Flashdog", "Dabtype", "Topicshots"],
      ...
      "first_name": "Walter",
      "last_name": "Diaz",
      "client": ["Skynoodle", "Shufflester", "Yodo"],
      "skill": ["JavaSE", "Knowledge Sharing"],
      "recruiter": "Ricky",
      ...
      "first_name": "Clarence",
      "last_name": "Coleman",
      "client": ["Latz", "Wordify", "Mycat"],
      "skill": ["SAP Business ByDesign", "DVD Authoring"],
      "recruiter": "Ricky",
      "placement_type": "full-time",
      "salary": 63776,
      "insurance": 386,
      ...
      "first_name": "Carolyn",
      "last_name": "Cruz",
      "client": ["Browsedrive", "Youtags", "Divape"],
      "skill": ["OBIEE"],
      "recruiter": "Arnold",
      "placement_type": "project",
      "salary": 76511,
      ...
      "client": ["Yodel", "Devpoint"],
      "skill": ["National Security", "RPG III"],
      "recruiter": "Ricky",
      "placement_type": "project",
      "salary": 53474,
      "insurance": 784,
      ...
      "first_name": "Tina",
      "last_name": "Mccoy",
      "client": ["Cogibox", "Reallinks"],
      "skill": ["Automotive", "DVD"],
      "recruiter": "Bobby",
      "placement_type": "project",
      "salary": 97786,
      "insurance": 346,
      ...
      "first_name": "Janet",
      "last_name": "Bishop",
      "client": ["Rhybox", "Skippad", "Digitube"],
      "skill": ["Lawson HRIS", "Drupal"],
      "recruiter": "Bobby",
      "placement_type": "full-time",
      "salary": 86142,
      "insurance": 511,
      ...
      "first_name": "Bruce",
      "last_name": "Palmer",
      "client": ["Brightbean", "Mycat", "Thoughtsphere"],
      "skill": ["SI", "User Scenarios"],
      "recruiter": "Bobby",
      "placement_type": "project",
      "salary": 97995,
      "insurance": 166,
      ...
      "first_name": "Bonnie",
      "last_name": "Stevens",
      "client": ["Jabbersphere", "Bubblemix", "Ntag"],
      ...
      "first_name": "Cheryl",
      "last_name": "Frazier",
      "client": ["Avavee", "Jabberbean", "Linkbridge"],
      "skill": ["Offshore Oil", "EHR"],
      "recruiter": "Ricky",
      "placement_type": "project",
      "salary": 57943,
      "insurance": 869,
...
_employee2.default.find({}).remove().then(function () {
  _employee2.default.create({
    "first_name": "Adam",
    "last_name": "Griffin",
    "client": ["Mudo"],
    "skill": ["DDA"],
